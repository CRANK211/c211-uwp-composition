...
using C211.Uwp.Composition.Pages;
...
namespace RelativePanelImplicitAnimation
{
    ...
    sealed partial class App : Application
    {
        ...
        private async void PerformLoadingTask(ExtendedSplash extendedSplash)
        {
            await Task.Delay(3000);
            await extendedSplash.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, extendedSplash.DismissExtendedSplash);
        }
